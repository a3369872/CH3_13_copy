...
#     cID = models.ForeignKey('Student', on_delete=models.CASCADE, null=True) #外來鍵
...
class Student(models.Model):
    ...
    cEmail = models.CharField(max_length=50, blank=False)
    cPhone = models.CharField(max_length=20, blank=False)
    cAddr = models.CharField(max_length=100, blank=False)
